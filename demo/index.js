...
const newEffect = new MyPlugin.Polymorph(
  {
    animatedAttrs: {
...
const newEffect2 = new MyPlugin.Polymorph(
  {
    animatedAttrs: {
...
clip.addIncident(newEffect2, 1500);
